...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='data/input',
                        help='Directory name to save the model')
    ...
    parser.add_argument('--pre_modelG', type=str, default='./models/data/input/pre_GAN/pre_GAN_G.pkl')
    parser.add_argument('--pre_modelD', type=str, default='./models/data/input/pre_GAN/pre_GAN_D.pkl')
